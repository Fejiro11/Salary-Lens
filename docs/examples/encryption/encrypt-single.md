...
> Demonstrates how to encrypt a single value from user input
...
Shows the complete flow from plaintext -> encrypted -> stored
...
**Parameters:**
- `encryptedValue`: The encrypted uint32 value
- `inputProof`: ZK proof validating the encryption

### `requestDecryption()`

Request decryption of caller's stored value
