...
Demonstrates FHE.add operation with plaintext value

### `addEncrypted()`

Add an encrypted value to the counter

Demonstrates FHE.add with two encrypted values

**Parameters:**
- `encryptedValue`: The encrypted value to add
- `inputProof`: Zero-knowledge proof for the encrypted input

### `requestDecryption()`

Request public decryption of the counter

After calling this, use relayer-sdk to decrypt off-chain
