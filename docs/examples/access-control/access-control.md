...
> Demonstrates FHE permission management patterns
...
Demonstrates basic permission setup after storing encrypted value

### `grantViewAccess()`

Grant another address permission to view your balance

This demonstrates sharing encrypted values between users

**Parameters:**
- `viewer`: The address to grant view access

### `requestOwnDecryption()`

Request decryption of your own balance

### `requestViewerDecryption()`

Request decryption of another user's balance (if granted)

**Parameters:**
- `owner`: The address whose balance to decrypt
