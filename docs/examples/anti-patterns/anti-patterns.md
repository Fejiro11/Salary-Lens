...
> Demonstrates common FHE mistakes and how to avoid them
...
This contract shows what NOT to do, with correct alternatives
...
View functions cannot return encrypted values because:

Use the public decryption pattern to reveal values

### `setValueCorrect()`

❌ WRONG: Missing FHE.allowThis()

Without allowThis, the contract loses access to the value

### `selectMaxValue()`

❌ WRONG: Cannot use encrypted values in require

Encrypted comparisons return ebool, not bool
